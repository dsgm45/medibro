...
echo "=== MediBro: Medicine reminder UI overhaul (presets, collapsible, nicer schedule) ==="
...
git add app.py templates/medicines.html templates/medicine_edit.html
git commit -m "Medicine UI overhaul: preset time chips, collapsible add form, grouped schedule view"
git push origin main

echo ""
echo "=== Done. Check Render dashboard for the new deploy. ==="
echo "No new database columns in this batch - purely UI/UX and route logic changes."
